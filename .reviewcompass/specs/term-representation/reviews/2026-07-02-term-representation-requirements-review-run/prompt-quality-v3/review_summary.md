# Review run summary: prompt-quality-v3

variant: api_review_prompt_quality_2way_openai_adversarial
...
| --- | --- | --- | ---: | --- | --- |
| gpt-5.5 | parsed | triage_pending | 1 | INFO:1 | raw/gpt-5.5.round-1.txt |
